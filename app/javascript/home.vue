<template>
  <span>
    ...
    <Heading>Why do I need snow tires?</Heading>
    <Txt>
    ...
    <Heading>How much better are snow tires in the winter?</Heading>
    <Txt>
    ...
    <Heading>Do I need snow tires if I have all-wheel drive or 4WD?</Heading>
    <Txt>
    ...
    <Heading>When do I need to put on snow tires?</Heading>
    <Txt>
      You need to install your snow tires before your local temperature gets
      below 45° F.
    </Txt>

    <Heading>How do I buy snow tires?</Heading>
    <Txt>
